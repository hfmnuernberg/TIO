...
use crate::util::constants::{AUDIO_STREAM_CREATE_TIMEOUT_SECONDS, OUTPUT_SAMPLE_RATE};
use crate::util::debug_log::debug_log;
use crate::util::util_functions::get_platform_default_cpal_output_config;
...
pub fn generator_create_audio_stream() -> bool {
    ...
    if config.is_none() {
        debug_log("Could not start generator output stream - Could not get default output config");
        return false;
    }
