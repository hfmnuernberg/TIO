...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 674961314;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        8 => wire__crate__api__api__media_player_get_recording_samples_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        9 => wire__crate__api__api__media_player_get_rms_impl(port, ptr, rust_vec_len, data_len),
        10 => wire__crate__api__api__media_player_get_state_impl(port, ptr, rust_vec_len, data_len),
        11 => wire__crate__api__api__media_player_load_wav_impl(port, ptr, rust_vec_len, data_len),
        12 => wire__crate__api__api__media_player_set_loop_impl(port, ptr, rust_vec_len, data_len),
        13 => wire__crate__api__api__media_player_set_pitch_semitones_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        14 => wire__crate__api__api__media_player_set_playback_pos_factor_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        15 => wire__crate__api__api__media_player_set_speed_factor_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        16 => wire__crate__api__api__media_player_set_trim_impl(port, ptr, rust_vec_len, data_len),
        17 => {
            wire__crate__api__api__media_player_set_volume_impl(port, ptr, rust_vec_len, data_len)
        }
        18 => wire__crate__api__api__media_player_start_impl(port, ptr, rust_vec_len, data_len),
        19 => wire__crate__api__api__media_player_start_recording_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        20 => wire__crate__api__api__media_player_stop_impl(port, ptr, rust_vec_len, data_len),
        21 => wire__crate__api__api__media_player_stop_recording_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        22 => wire__crate__api__api__metronome_load_file_impl(port, ptr, rust_vec_len, data_len),
        23 => wire__crate__api__api__metronome_poll_beat_event_happened_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        24 => wire__crate__api__api__metronome_set_beat_mute_chance_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        25 => wire__crate__api__api__metronome_set_bpm_impl(port, ptr, rust_vec_len, data_len),
        26 => wire__crate__api__api__metronome_set_muted_impl(port, ptr, rust_vec_len, data_len),
        27 => wire__crate__api__api__metronome_set_rhythm_impl(port, ptr, rust_vec_len, data_len),
        28 => wire__crate__api__api__metronome_set_volume_impl(port, ptr, rust_vec_len, data_len),
        29 => wire__crate__api__api__metronome_start_impl(port, ptr, rust_vec_len, data_len),
        30 => wire__crate__api__api__metronome_stop_impl(port, ptr, rust_vec_len, data_len),
        31 => wire__crate__api__api__piano_note_off_impl(port, ptr, rust_vec_len, data_len),
        32 => wire__crate__api__api__piano_note_on_impl(port, ptr, rust_vec_len, data_len),
        33 => wire__crate__api__api__piano_set_volume_impl(port, ptr, rust_vec_len, data_len),
        34 => wire__crate__api__api__piano_setup_impl(port, ptr, rust_vec_len, data_len),
        35 => wire__crate__api__api__piano_start_impl(port, ptr, rust_vec_len, data_len),
        36 => wire__crate__api__api__piano_stop_impl(port, ptr, rust_vec_len, data_len),
        37 => wire__crate__api__api__tuner_get_frequency_impl(port, ptr, rust_vec_len, data_len),
        38 => wire__crate__api__api__tuner_start_impl(port, ptr, rust_vec_len, data_len),
        39 => wire__crate__api__api__tuner_stop_impl(port, ptr, rust_vec_len, data_len),
        40 => wire__crate__api__simple__init_rust_defaults_manually_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
