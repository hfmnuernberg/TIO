...
class RhythmPreset extends Equatable {
  ...
  static final RhythmPreset oneFourth = RhythmPreset(
    beats: List.unmodifiable([BeatType.Accented, BeatType.Unaccented, BeatType.Unaccented, BeatType.Unaccented]),
    polyBeats: List.unmodifiable([]),
    noteKey: NoteValues.quarter,
  );

  static final RhythmPreset twoEighth = RhythmPreset(
    beats: List.unmodifiable([BeatType.Accented, BeatType.Unaccented, BeatType.Unaccented, BeatType.Unaccented]),
    polyBeats: List.unmodifiable(_repeatPolyBeatPattern(4, [BeatTypePoly.Muted, BeatTypePoly.Unaccented])),
    noteKey: NoteValues.quarter,
  );
  ...
  static RhythmPreset fromKey(RhythmPresetKey key) => switch (key) {
    RhythmPresetKey.oneFourth => oneFourth,
    RhythmPresetKey.twoEighth => twoEighth,
