...
class NumberInputForDouble extends StatefulWidget {
  final double max;
  final double min;
  ...
  @override
  State<NumberInputForDouble> createState() => _NumberInputForDoubleState();
}

class _NumberInputForDoubleState extends State<NumberInputForDouble> {
