...
class OldAppSliderInt extends StatefulWidget {
  final int min;
  final int max;
  ...
  @override
  State<OldAppSliderInt> createState() => _OldAppSliderIntState();
}

class _OldAppSliderIntState extends State<OldAppSliderInt> {
