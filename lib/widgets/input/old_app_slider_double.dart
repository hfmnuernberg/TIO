...
class OldAppSliderDouble extends StatefulWidget {
  final double min;
  final double max;
  ...
  @override
  State<OldAppSliderDouble> createState() => _OldAppSliderDoubleState();
}

class _OldAppSliderDoubleState extends State<OldAppSliderDouble> {
