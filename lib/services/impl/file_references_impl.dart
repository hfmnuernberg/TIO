...
class FileReferencesImpl implements FileReferences {
  ...
  @override
  Future<void> inc(String path) async => _refs[path] = _refs.containsKey(path) ? _refs[path]! + 1 : 1;
  ...
  int _countImageRefs(String path, ProjectLibrary projectLibrary) => projectLibrary
      .projects
  ...
  int _countMediaPlayerRefs(String path, ProjectLibrary projectLibrary) => projectLibrary
      .projects
      .expand((project) => project.blocks)
