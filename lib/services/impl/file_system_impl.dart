...
class FileSystemImpl implements FileSystem {
  ...
  FileSystemImpl(PathProvider pathProvider, this._filePicker, this._imagePicker, this._sharePlus) {
    _asyncInit(pathProvider);
  }

  Future<void> _asyncInit(PathProvider pathProvider) async {
    appFolderPath = (await pathProvider.getApplicationDocumentsDirectory()).path;
    tmpFolderPath = (await pathProvider.getTemporaryDirectory()).path;
  }
  ...
  @override
  String? toExtension(String filePath) => filePath.split('.').lastOrNull;
