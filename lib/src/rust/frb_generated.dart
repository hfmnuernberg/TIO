...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -2007801049;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<bool> crateApiFfiMediaPlayerSetSecondaryAudioVolume({
    required double volume,
  });
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  TaskConstMeta get kCrateApiFfiMediaPlayerLoadSecondaryProcessedConstMeta =>
      const TaskConstMeta(
  ...
  TaskConstMeta get kCrateApiFfiMediaPlayerRenderMidiToWavConstMeta =>
      const TaskConstMeta(
  ...
  Future<bool> crateApiFfiMediaPlayerSetSecondaryAudioVolume({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiFfiMediaPlayerSetSecondaryAudioVolumeConstMeta,
        argValues: [volume],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiFfiMediaPlayerSetSecondaryAudioVolumeConstMeta =>
      const TaskConstMeta(
        debugName: "media_player_set_secondary_audio_volume",
        argNames: ["volume"],
      );
  ...
  TaskConstMeta get kCrateApiFfiMediaPlayerUnloadSecondaryAudioConstMeta =>
      const TaskConstMeta(
        debugName: "media_player_unload_secondary_audio",
        argNames: [],
      );
