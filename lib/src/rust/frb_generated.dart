...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 714037602;
...
abstract class RustLibApi extends BaseApi {
  Future<Float32List> crateApiFfiComputeRmsFromFile({required String wavFilePath, required int nBins});
  ...
  Future<bool> crateApiFfiMediaPlayerLoadSecondaryProcessed({
  ...
  Future<bool> crateApiFfiMediaPlayerUnloadSecondaryAudio();
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<Float32List> crateApiFfiComputeRmsFromFile({required String wavFilePath, required int nBins}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiFfiComputeRmsFromFileConstMeta,
        argValues: [wavFilePath, nBins],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiFfiComputeRmsFromFileConstMeta =>
      const TaskConstMeta(debugName: "compute_rms_from_file", argNames: ["wavFilePath", "nBins"]);
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_f_32(trimStartFactor, serializer);
          sse_encode_f_32(trimEndFactor, serializer);
          sse_encode_f_32(volume, serializer);
          pdeCallFfi(generalizedFrbRustBinding, serializer, funcId: 13, port: port_);
        },
        codec: SseCodec(decodeSuccessData: sse_decode_bool, decodeErrorData: null),
        constMeta: kCrateApiFfiMediaPlayerLoadSecondaryProcessedConstMeta,
        argValues: [wavFilePath, pitchSemitones, speedFactor, trimStartFactor, trimEndFactor, volume],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiFfiMediaPlayerLoadSecondaryProcessedConstMeta => const TaskConstMeta(
    debugName: "media_player_load_secondary_processed",
    argNames: ["wavFilePath", "pitchSemitones", "speedFactor", "trimStartFactor", "trimEndFactor", "volume"],
  );
  ...
  Future<bool> crateApiFfiMediaPlayerUnloadSecondaryAudio() {
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(decodeSuccessData: sse_decode_bool, decodeErrorData: null),
        constMeta: kCrateApiFfiMediaPlayerUnloadSecondaryAudioConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiFfiMediaPlayerUnloadSecondaryAudioConstMeta =>
      const TaskConstMeta(debugName: "media_player_unload_secondary_audio", argNames: []);
