...
Future<bool> mediaPlayerSetPlaybackPosFactor({required double posFactor}) =>
    RustLib.instance.api
        .crateApiApiMediaPlayerSetPlaybackPosFactor(posFactor: posFactor);
...
Future<bool> metronomeLoadFile(
    ...
    RustLib.instance.api.crateApiApiMetronomeLoadFile(
        beatType: beatType, wavFilePath: wavFilePath);

Future<bool> metronomeSetRhythm(
        {required List<MetroBar> bars, required List<MetroBar> bars2}) =>
    RustLib.instance.api
        .crateApiApiMetronomeSetRhythm(bars: bars, bars2: bars2);
