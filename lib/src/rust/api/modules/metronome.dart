...
// These types are ignored because they are neither used by any `pub` functions nor (for structs and enums) marked `#[frb(unignore)]`: `BEAT_EVENT_HAPPENED`, `BEAT_MUTE_CHANCE`, `BPM`, `CURRENTLY_PLAYING_BUFFERS`, `CommandMetro`, `LOADED_AUDIO_BUFFERS`, `MUTED`, `RHYTHM_2`, `RHYTHM`, `THREAD_SENDER`, `THREAD`
