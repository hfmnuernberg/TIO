...
// These functions are ignored because they are not marked as `pub`: `apply_headroom_if_many`, `ensure_output_stream`, `get_or_create`, `mix_output_callback`, `mp_compute_rms`, `mp_get_state`, `mp_load`, `mp_set_loop_value`, `mp_set_pitch`, `mp_set_pos_factor`, `mp_set_speed`, `mp_set_trim_by_factor`, `mp_set_volume`, `mp_start`, `mp_stop`, `new`, `on_audio_callback`, `pitch_shift`, `thread_handle_command`
...
// These functions are ignored (category: IgnoreBecauseOwnerTyShouldIgnore): `compute_rms`, `get_state`, `new`, `set_loop_value`, `set_pitch`, `set_pos_factor`, `set_speed`, `set_trim_by_factor`, `set_volume`, `start`, `stop`
