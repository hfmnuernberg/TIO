...
class _SetRandomMuteState extends State<SetRandomMute> {
  ...
  void handleChange(newValue) async {
    ...
    as.metronomeSetBeatMuteChance(muteChance: newValue / 100.0).then((success) => null);
  }
  ...
  void handleConfirm() async {
    ...
    as.metronomeSetBeatMuteChance(muteChance: value / 100.0).then((success) => null);
  ...
  void _handleCancel() {
    as.metronomeSetBeatMuteChance(muteChance: metronomeBlock.randomMute / 100.0).then((success) => null);
    Navigator.pop(context);
  }
