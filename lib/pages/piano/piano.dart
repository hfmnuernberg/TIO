                              ...
                              return StatefulBuilder(
                                builder: (context, setTileState) {
                                  return CardListTile(
                                    ...
                                    leadingPicture: FileImage(File(_fs.toAbsoluteFilePath(projectLibrary.projects[index].thumbnailPath))),
  ...
  void _hideTextInputOverlay(bool submitted, StateSetter setTileState, int index) async {
    ...
    if (submitted) {
      ...
      if (mounted) {
        ...
        await saveToolInProject(context, index, _pianoBlock, widget.isQuickTool, _newToolTitle.text, pianoAlreadyOn: true);
      }
    }
  }
