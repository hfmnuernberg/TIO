  ...
  Widget build(BuildContext context) {
    ...
    return InfoPage(
      ...
      textSections: [
        ...
        const TextSection(
            content: "Features", sectionType: SectionType.headline2),
        const TextSection(
            content: "Projects", sectionType: SectionType.headline3),
        const TextSection(
            content:
        ...
        const TextSection(
            content: "Metronome", sectionType: SectionType.headline3),
        const TextSection(
            content:
        ...
        const TextSection(
            content: "Media player", sectionType: SectionType.headline3),
        const TextSection(
            content:
        ...
        const TextSection(
          content: "Imprint",
          sectionType: SectionType.headline2,
        ),
        const TextSection(
        ...
        InkWell(
          child: const Text('https://www.hfm-nuernberg.de/',
              style: TextStyle(color: ColorTheme.tertiary)),
          onTap: () async {
        ...
        const TextSection(
          content: "Developer: Studio Fluffy",
          sectionType: SectionType.text,
        ),
        InkWell(
          child: const Text('https://studiofluffy.de/',
              style: TextStyle(color: ColorTheme.tertiary)),
          onTap: () async {
        ...
        const TextSection(
            content: "Data protection", sectionType: SectionType.headline2),
        const TextSection(
            content:
