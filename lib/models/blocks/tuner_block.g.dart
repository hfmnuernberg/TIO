...
TunerBlock _$TunerBlockFromJson(Map<String, dynamic> json) =>
    TunerBlock(
      ...
      ..tunerType =
          $enumDecodeNullable(_$TunerTypeEnumMap, json['tunerType']) ??
          TunerType.chromatic;

Map<String, dynamic> _$TunerBlockToJson(TunerBlock instance) =>
    <String, dynamic>{
      'kind': instance.kind,
