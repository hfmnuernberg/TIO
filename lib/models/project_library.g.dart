...
ProjectLibrary _$ProjectLibraryFromJson(Map<String, dynamic> json) => ProjectLibrary(
  ...
  json['showFlashCardsPageTutorial'] as bool? ?? true,
  ...
  json['showMediaPlayerEditMarkersTutorial'] as bool? ?? true,
  json['showMediaPlayerSetTrimTutorial'] as bool? ?? true,
  ...
  (json['bookmarkedFlashCards'] as List<dynamic>?)?.map((e) => e as String).toList() ?? [],
...
Map<String, dynamic> _$ProjectLibraryToJson(ProjectLibrary instance) => <String, dynamic>{
  ...
  'bookmarkedFlashCards': instance.bookmarkedFlashCards,
  ...
  'showFlashCardsPageTutorial': instance.showFlashCardsPageTutorial,
  ...
  'showMediaPlayerEditMarkersTutorial': instance.showMediaPlayerEditMarkersTutorial,
  'showMediaPlayerSetTrimTutorial': instance.showMediaPlayerSetTrimTutorial,
