...
class PianoParams {
  ...
  static const List<String> soundFontPaths = <String>[
    "assets/sound_fonts/legacy_piano.sf2",
    "assets/sound_fonts/piano.sf2",
    "assets/sound_fonts/legacy_electric_piano.sf2",
    "assets/sound_fonts/electric_piano.sf2",
    "assets/sound_fonts/legacy_reverb_bell_piano.sf2",
...
final blockTypeInfos = {
  BlockType.tuner: BlockTypeInfo(
    ...
    (String title) => TunerBlock.withTitle(title),
    (Map<String, dynamic> json) => TunerBlock.fromJson(json),
  ),
  BlockType.metronome: BlockTypeInfo(
    ...
    (String title) => MetronomeBlock.withTitle(title),
    (Map<String, dynamic> json) => MetronomeBlock.fromJson(json),
  ),
  BlockType.mediaPlayer: BlockTypeInfo(
    ...
    (String title) => MediaPlayerBlock.withTitle(title),
    (Map<String, dynamic> json) => MediaPlayerBlock.fromJson(json),
  ),
  BlockType.image: BlockTypeInfo(
    ...
    (String title) => ImageBlock.withTitle(title),
    (Map<String, dynamic> json) => ImageBlock.fromJson(json),
  ),
  BlockType.piano: BlockTypeInfo(
    ...
    (String title) => PianoBlock.withTitle(title),
    (Map<String, dynamic> json) => PianoBlock.fromJson(json),
  ),
  BlockType.text: BlockTypeInfo(
    ...
    (String title) => TextBlock.withTitle(title),
    (Map<String, dynamic> json) => TextBlock.fromJson(json),
  ),
};
