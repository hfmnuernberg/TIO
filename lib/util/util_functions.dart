              ...
              children: [
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    label: Text(l10n.generalToolNewProjectTitle, style: const TextStyle(color: ColorTheme.surfaceTint)),
                  ),
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    border: const OutlineInputBorder(borderSide: BorderSide(color: ColorTheme.primary)),
                    enabledBorder: const OutlineInputBorder(borderSide: BorderSide(color: ColorTheme.primary)),
                    label: Text(l10n.generalToolNewTitle, style: const TextStyle(color: ColorTheme.surfaceTint)),
                  ),
                  style: const TextStyle(color: ColorTheme.primary),
