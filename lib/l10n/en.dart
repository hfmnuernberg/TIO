...
class English extends AppLocalizations {
  ...
  String get mediaPlayerTutorialIslandTool => 'Tap here to combine your tool with other Tuner or Metronome tools. You can create new tools or link existing ones.';
  ...
  String get metronomeTutorialIslandTool => 'Tap here to combine your tool with other Tuner or Media Player tools. You can create new tools or link existing ones.';
  ...
  String get pianoTutorialIslandTool => 'Tap here to combine your tool with other Tuner, Media Player, or Metronome tools. You can create new tools or link existing ones.';
  ...
  String get tunerTutorialIslandTool => 'Tap here to combine your tool with other Metronome or Media Player tools. You can create new tools or link existing ones.';
