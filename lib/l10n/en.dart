...
class English extends AppLocalizations {
  ...
  String get aboutPageFirstParagraph => 'TIO Music integrates numerous tools (tuner, metronome, media player, piano, image notes and text notes) in one app and enables the combined use of the individual tools. By creating projects, it is possible to save different configurations and thus make practicing and making music easier. The tools can also be used individually, for quick tuning of instruments or for recording samples. TIO Music was developed by musicians for musicians of all levels of experience, for amateurs and professionals. The app is and will remain completely free of charge and ad-free.';
  String get aboutPageImage => 'Image';
  String get aboutPageImageExplanation => 'You can upload pictures or note sheets to the app using the camera on your device.';
  String get aboutPageImprint => 'Imprint';
  String get aboutPageMediaPlayer => 'Media player';
  String get aboutPageMediaPlayerExplanation => 'You can record, load and edit audio files and save configurations. In doing so, you can set your preferred volume, range (length and segment), playing speed and pitch. You can forward your projects to others using external messenger services.';
  String get aboutPageMetronome => 'Metronome';
  String get aboutPageMetronomeExplanation => 'The metronome allows you to save and recall your individual configurations (tempo, time signature, polyrhythms, random mute, sounds). You can also combine the metronome with the tuner and the media player.';
  String get aboutPagePiano => 'Piano';
  String get aboutPagePianoExplanation => 'You can use the built-in piano, select different sound modes and save your individual configurations.';
  String get aboutPageProjects => 'Projects';
  String get aboutPageProjectsExplanation => 'You can create projects and save the required settings there (settings for instrument tuning, metronome settings, etc.), so you can access them whenever you want.';
  String get aboutPageSecondParagraph => 'We aim to continuously improve the app for you - so we look forward to your feedback!';
  String get aboutPageText => 'Text';
  String get aboutPageTextExplanation => 'You can use your device to create text notes, e.g. for playing instructions, background information, song lyrics etc.';
  String get aboutPageThirdParagraph => 'This app was developed as part of the RE|LEVEL-project at Hochschule für Musik Nürnberg. RE|LEVEL is funded by Stiftung Innovation in der Hochschullehre.';
