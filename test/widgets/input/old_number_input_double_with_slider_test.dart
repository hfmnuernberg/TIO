...
class TestWrapper extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return OldNumberInputDoubleWithSlider(
      min: min,
      max: max,
...
void main() {
  ...
  group('number input double with slider', () {
    group('number input double', () {
      testWidgets('increases input value when tapping plus button', (tester) async {
      ...
      testWidgets('increases input value based on given step when tapping plus button', (tester) async {
        await tester.renderWidget(TestWrapper(defaultValue: 10, step: 0.1));
        expect(tester.getSemantics(find.bySemanticsLabel('Test input')).value, '10.0');
      ...
      testWidgets('decreases input value when tapping minus button', (tester) async {
        await tester.renderWidget(TestWrapper(defaultValue: 10));
        expect(tester.getSemantics(find.bySemanticsLabel('Test input')).value, '10.0');
      ...
      testWidgets('changes input value when entering new value in text field', (tester) async {
        await tester.renderWidget(TestWrapper(defaultValue: 10));
        expect(tester.getSemantics(find.bySemanticsLabel('Test input')).value, '10.0');
      ...
      testWidgets('changes input value to max when entering too high value in text field', (tester) async {
      ...
      testWidgets('changes input value to min when entering too low value in text field', (tester) async {
      ...
      testWidgets('does not change input value when entering invalid value in text field', (tester) async {
        await tester.renderWidget(TestWrapper(defaultValue: 20, min: 10));
        expect(tester.getSemantics(find.bySemanticsLabel('Test input')).value, '20.0');
      ...
      testWidgets('does not change input value when entering new empty value in text field', (tester) async {
      ...
      testWidgets('changes input value to min when entering negative value is allowed in text field', (tester) async {
