...
void main() {
  ...
  group('MediaPlayerTool - waveform navigation', () {
    group('edit markers page', () {
      testWidgets('shows start, ending and playback time initially', (tester) async {
      ...
      testWidgets('shows new start and end time after zoomed in', (tester) async {
        await prepareAndOpenMediaPlayer(tester, context);
        await tester.scrollToAndTapAndSettle('Markers');
